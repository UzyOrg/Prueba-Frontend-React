...
const _app = () => {
    ...
    const insertar =()=>{
        ...
        // Obtiene el valor que se escribe en los inputs
        var artiInsertar = articuloSeleccionado;

         // Le da una id mayor que el anterior
                ...
                <div className="login-parent">
                    <div className="login-container">
                        <div className="login-div">
                            ...
                            <input type="reset" value="Agregar articulo"  className="addButton" onClick={()=>{insertar(); abrirModalInsertar();}}/>
                        </div>
                    </div>
                </div>
            </form>
